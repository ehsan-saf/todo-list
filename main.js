...
function isDateToday(date) {
    if(date.trim().length === 0 || (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(date))) {
         return true;
    }
    return false;
}
