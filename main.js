...
function loadAllTasks() {
    _folder__WEBPACK_IMPORTED_MODULE_1__.foldersArray.forEach(folder => {
        folder.tasks.forEach(task => {
            if((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.dueDate))
            createTask(task);
        });
    });
}
...
function formatDate(date) {
    ...
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(date), "yyyy / MM / dd");
}

function isDateToday(date) {
    if(date.trim().length === 0 || (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(date))) {
         return true;
    }
    return false;
}
