...
/* harmony export */   initialize: () => (/* binding */ initialize),
/* harmony export */   loadFolders: () => (/* binding */ loadFolders)
/* harmony export */ });
...
function initialize() {
    ...
    if(!_folder__WEBPACK_IMPORTED_MODULE_0__.foldersArray.some(fl => fl.name === "Default")) {
...
function loadFolders() {
    ...
    _folder__WEBPACK_IMPORTED_MODULE_0__.foldersArray.forEach(fl => {
        ...
        removeButton.addEventListener("click", _folder__WEBPACK_IMPORTED_MODULE_0__.removeFolder);
...
function showInfo(event) {
    saveMode = 2;
    targetTask = (0,_taskDom__WEBPACK_IMPORTED_MODULE_2__.getEventTask)(event);
    newTaskModal.showModal();
...
function formatDate(date) {
    if(date.trim().length === 0) {
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), 'yyyy-MM-dd');
    }
    return date;
}
...
/* harmony import */ var _modifyTask__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modifyTask */ "./src/domScripts/modifyTask.js");
...
function loadTasks() {
    (0,_folder__WEBPACK_IMPORTED_MODULE_1__.saveLocal)();
    todoList.innerHTML = "";
...
function createTask(task) {
    ...
    priority.addEventListener("click", _task__WEBPACK_IMPORTED_MODULE_2__.changePriority);
    ...
    infoButton.id = "info";
    infoButton.addEventListener("click", _modifyTask__WEBPACK_IMPORTED_MODULE_3__.showInfo);
...
function formatDate(date) {
    ...
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(date), "yyyy / MM / dd");
}

function isDateToday(date) {
    if((0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(date))) {
         return true;
    }
    return false;
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   addFunctions: () => (/* binding */ addFunctions),
...
/* harmony export */   updateFolderArray: () => (/* binding */ updateFolderArray)
/* harmony export */ });
...
function addFunctions(data) {
    data.forEach(folder => {
        ...
        folder.tasks.forEach(task => {
            task.toggleComplete = _task__WEBPACK_IMPORTED_MODULE_2__.toggleComplete;
        });
    });
}
...
function removeFolder(event) {
    ...
    updateFolderArray();
    saveLocal();
    (0,_domScripts_folderDom__WEBPACK_IMPORTED_MODULE_0__.loadFolders)();
}

function updateFolderArray() {
...
/* harmony import */ var _folder__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./folder */ "./src/folder.js");
/* harmony import */ var _domScripts_taskDom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./domScripts/taskDom */ "./src/domScripts/taskDom.js");





(0,_folder__WEBPACK_IMPORTED_MODULE_1__.loadLocal)();
(0,_domScripts_dom__WEBPACK_IMPORTED_MODULE_0__.initialize)();
(0,_domScripts_taskDom__WEBPACK_IMPORTED_MODULE_2__.loadTasks)();
...
/* harmony export */ });
/* harmony import */ var _domScripts_taskDom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./domScripts/taskDom */ "./src/domScripts/taskDom.js");
...
function changePriority(event) {
    const task = (0,_domScripts_taskDom__WEBPACK_IMPORTED_MODULE_0__.getEventTask)(event);
    task.priority++;
    if(task.priority === 5) {
        task.priority = 1;
    }
    (0,_domScripts_taskDom__WEBPACK_IMPORTED_MODULE_0__.loadTasks)();
}
