...
function formatDate(date) {
    if(date.trim().length === 0) {
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), "yyyy / MM / dd");
    }
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(date), "yyyy / MM / dd");
}
