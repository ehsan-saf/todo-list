...
function initialize() {
    ...
    if(!_folder__WEBPACK_IMPORTED_MODULE_0__.foldersArray.some(fl => fl.name === "Default")) {
        ...
        console.log(_folder__WEBPACK_IMPORTED_MODULE_0__.foldersArray);
    };
    loadFolders();
    selectDefaultFolder();
}
